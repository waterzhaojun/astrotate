...
def main(fatherid = args.dad, motherid = args.mom, cageid = args.cageid, server = args.server, 
    ...
    cur = conn.cursor()
    cur.execute("INSERT INTO transgenic_mouse_breeding (mateid, cageid, fathter_id, mother_id, pair_date) VALUES ({}, {}, {}, {}, current_date);", 
                (newmate, cageid, fatherid, motherid)
    )
    conn.commit()
